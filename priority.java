...
import org.cloudbus.cloudsim.DatacenterBrokerPriority;
		...
		Log.printLine("Starting CloudSimExample2...");
	        ...
	        try {
	        	// First step: Initialize the CloudSim package. It should be called
	            	...
	            	DatacenterBrokerPriority broker = createBroker();
	            	...
	            	UtilizationModel utilizationModel = new UtilizationModelFull();
                        ...
                        for(int i=0;i<6;i++){
                            int p1;
                            Log.printLine("Enter Priority for Cloudlet "+i+" :");
                            p1=in.nextInt();
                        
                            NewCloudlet cloudlet1 = new NewCloudlet(i, length, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel,p1);
...
//                        int p1,p2,p3;
//                            Log.printLine("Enter Priority for Cloudlet 0 :");
//                            p1=in.nextInt();
//                        
//	            	NewCloudlet cloudlet1 = new NewCloudlet(id, length, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel,p1);
//	            	cloudlet1.setUserId(brokerId);
//                        
//                         Log.printLine("Enter Priority for Cloudlet 1 :");
//                            p2=in.nextInt();
//	            	id++;
//	            	NewCloudlet cloudlet2 = new NewCloudlet(id, length, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel,p2);
//	            	cloudlet2.setUserId(brokerId);
//
//                        
//                         Log.printLine("Enter Priority for Cloudlet 2 :");
//                            p3=in.nextInt();
//	            	id++;
//	            	NewCloudlet cloudlet3 = new NewCloudlet(id, length, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel,p3);
